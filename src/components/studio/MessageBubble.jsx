...
const FunctionDisplay = ({ toolCall }) => {
    ...
    const statusConfig = {
        ...
        running: { icon: Loader2, color: 'text-purple-600', text: 'Running...', spin: true },
        in_progress: { icon: Loader2, color: 'text-purple-600', text: 'Running...', spin: true },
        completed: isError ? 
        ...
        <div className="mt-2 text-xs">
            <button
                ...
                className={cn(
                    ...
                    "hover:bg-purple-50",
                    expanded ? "bg-purple-50 border-purple-300" : "bg-white border-gray-200"
                )}
            >
            ...
            {expanded && !statusConfig.spin && (
                <div className="mt-1.5 ml-3 pl-3 border-l-2 border-purple-200 space-y-2">
...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-8 w-8 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mt-0.5 shadow-lg">
                                ...
                                components={{
                                    code: ({ inline, className, children, ...props }) => {
                                        ...
                                        return !inline && match ? (
                                            ...
                                            <code className="px-1 py-0.5 rounded bg-purple-100 text-purple-700 text-xs font-mono">
                                                {children}
                                            </code>
                                        );
                                    },
                                    a: ({ children, ...props }) => (
                                        <a {...props} target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700 underline">{children}</a>
                                    ),
                                    ...
                                    blockquote: ({ children }) => (
                                        <blockquote className="border-l-2 border-purple-300 pl-3 my-2 text-slate-600">
                                            {children}
                                        </blockquote>
                                    ),
                                }}
